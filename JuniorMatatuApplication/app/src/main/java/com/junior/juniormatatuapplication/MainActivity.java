...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Intent picha= new Intent(MainActivity.this,Gallery.class);
            startActivityForResult(picha,0);


        }
        else if (id == R.id.comments) {
            Intent feedback= new Intent(MainActivity.this,Comments.class);
        ...
        {
            Intent fare= new Intent(MainActivity.this,Prices.class);
            startActivityForResult(fare,0);

        }
        else if (id == R.id.fleet)
        {
            Intent magari= new Intent(MainActivity.this,Fleet.class);
            startActivity(magari);
    ...
    public void Piga_simu(View view) {
        String number = "0704221030";
        Intent piga_simu = new Intent(Intent.ACTION_CALL);
        piga_simu.setData(Uri.parse("tel:" + number));
