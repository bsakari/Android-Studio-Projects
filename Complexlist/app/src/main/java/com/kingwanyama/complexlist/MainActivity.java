...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Item p1 = new Item("King Wanyama",
                "kingwanyama@gmail.com",300000,R.drawable.img_1);
        Item p2 = new Item("Benjamin Wanyama",
                "benjaminwanyama@gmail.com",600000,R.drawable.img_2);
