...
/**
 * Created by kingwanyama on 4/19/18.
 */
...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    static final List<WifiConfiguration.Protocol> DEFAULT_PROTOCOLS = Util.immutableList(
            WifiConfiguration.Protocol.HTTP_2, WifiConfiguration.Protocol.HTTP_1_1);
